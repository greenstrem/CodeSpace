...
@app.post("/load-github-file")
async def load_github_file(data: dict):
    url = data.get("url")
    if not url:
...
async def get_index():
    #TODO:
    # Убрать примеры с сложными библиотеками 
    # Убрать это обратно в темплейтс !!!ВАЖНО!!!
    # Доработать кнопки с боку
    return """
    <!DOCTYPE html>
    <html>
    <head>
